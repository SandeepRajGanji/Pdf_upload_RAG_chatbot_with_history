...
st.title("Conversational RAG bot With PDF uplaods and chat history")
...
if api_key:
    ...
    if uploaded_files:
        ...
        system_q = ChatPromptTemplate.from_messages(
            [
        ...
        question_answer_chain=create_stuff_documents_chain(llm,system_q)
